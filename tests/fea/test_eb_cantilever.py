...
class EulerBernoulliCantilever(unittest.TestCase):
    def test_tip_load(self):
        ...
        r = eb_problem.force_vector - eb_problem.stiffness_matrix @ eb_problem.displacements
    ...
    def test_tip_and_mid_load(self):
        ...
        eb_problem = EulerBernoulliProblem([element1, element2], bcs=[0,1], loads=[0,0,P,0,P,0])
        eb_problem.solve()
